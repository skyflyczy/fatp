    ...
    <div class="pages">
        ...
        <div class="selectPagesize">
            <select data-toggle="selectpicker" data-toggle-change="changepagesize">
            	<option value="5" <if condition="$Think.session.pageSize eq 5">selected="selected"</if>>5</option>
            	<option value="10" <if condition="$Think.session.pageSize eq 10">selected="selected"</if>>10</option>
