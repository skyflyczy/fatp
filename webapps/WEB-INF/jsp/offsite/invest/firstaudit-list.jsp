...
<div class="bjui-pageHeader">
    <form id="pagerForm" data-toggle="ajaxsearch" action="<%=request.getContextPath()%>/offsite/invest/invest-firstaudit-list.do">
    	...
    	<tbody>
    		<c:forEach items="${list}" var="obj" varStatus="status">
    			<tr align="center">
    				...
    				<td>
    					<c:if test="${obj.canFirstAudit()}">
    					<a href="<%=request.getContextPath()%>/offsite/invest/to_firstaudit.do?applyGuid=${obj.applyGuid}" 
    					class="btn btn-blue" data-toggle="dialog" data-width="1000"  
    					data-height="600" data-id="dialog-mask" data-mask="true">初审</a>
    					</c:if>
