		 ...
		 <table class="table table-condensed table-noborder">
		 	...
		 	<tbody>
		 		<tr>
					...
					<td>
						<label class="control-label x140 discell">挂牌名称：</label> 
						<span class="w200 break discell">${obj.projectFullName }</span>
					</td>
...
<div class="bjui-pageFooter">
    <ul>
        <li><button type="submit" class="btn btn-orange" id="checkBackBtn">初审不通过</button></li>
        <li><button type="submit" class="btn-blue" id="checkPassBtn">初审通过</button></li>
    </ul>
</div>
<script>
$('#form').validator({
