...
<div class="bjui-pageContent">
	<form id="projectadd" action="<%=request.getContextPath()%>/project/listing/dxrz/add.do" data-toggle="validate" data-reload-navtab="true" data-confirm-msg="确定要保存吗？" data-callback="addprojectCallback">
				...
				<tr>
					<td>
						...
						<span><input readonly type="text" name="recordCode" id="recordCode" size="25" data-rule="required"
							data-toggle="lookup" data-title="备案选择" placeholder="请选择要挂牌的备案" data-url="<%=request.getContextPath()%>/project/listing/dxrz/recordlist.do" data-width="1000" data-height="600"></span>
					</td>
					<td>
...
function addprojectCallback(json) {
	if(json.statusCode == 200) {
		$(this).alertmsg("correct", json.message, {autoClose:false,okCall:function(){$(this).dialog('closeCurrent');$(this).dialog({id:'dialog-edit',onClose:function(){$(this).navtab("refresh");},title:'编辑',width:1000,height:600,mask:true,url:'<%=request.getContextPath()%>/project/listing/dxrz/edit.do?id='+json.id});}});
	}else {
