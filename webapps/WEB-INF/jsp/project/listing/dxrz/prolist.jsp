...
<div class="bjui-pageHeader">
    <form id="pagerForm" data-toggle="ajaxsearch" action="<%=request.getContextPath()%>/project/listing/dxrz/list.do">
        ...
        <div class="bjui-searchBar">
            <%@ include file="/WEB-INF/jsp/project/listing/dxrz/search_itembase.jsp" %>
            <button type="submit" class="btn-default" data-icon="search" data-clear-query="false">查询</button>
            <a class="btn btn-default" href="javascript:;" data-toggle="reloadsearch" data-clear-query="true" data-icon="undo">重置查询</a>
            <div class="pull-right">
	            <a href="<%=request.getContextPath()%>/project/listing/dxrz/new.do"
    ...
    <table data-toggle="tablefixed" data-nowrap="true">
    	...
    	<tbody>
   		...
   		<tr>
    		...
    		<td><a href="<%=request.getContextPath()%>/project/listing/view.do?id=${list.id}" 
    		...
    		<td align="center">
    			<c:if test="${list.canEdit()}">
	    			<a href="<%=request.getContextPath()%>/project/listing/dxrz/edit.do?id=${list.id}" 
