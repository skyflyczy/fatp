...
<div class="bjui-pageContent">
      ...
      <ul class="nav nav-tabs" role="tablist">
          ...
          <!-- 
          <li><a id="otherfiles_link" href="<%=request.getContextPath()%>/income/right/profiles/list.do?projectId=${obj.id}&projectTypeId=${obj.projectTypeId}&belongType=2" 
      ...
      <div class="tab-content">
          <div class="tab-pane fade active in" id="baseinfo">
          	<%@ include file="/WEB-INF/jsp/project/listing/syq/editpro.jsp" %>
          </div>
          <!-- 
          <div class="tab-pane fade" data-toggle="autoajaxload"  id="otherfiles"></div>
           -->
