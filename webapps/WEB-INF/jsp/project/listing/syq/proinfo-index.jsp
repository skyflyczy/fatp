...
<div class="bjui-pageContent">
        <div style="margin:0px auto 0; width:100%;">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <!-- 
                    <li><a href="<%=request.getContextPath()%>/incomeright/profiles/view.do?projectId=${obj.id}&belongType=2&projectTypeId=${obj.projectTypeId}" 
                ...
                <div class="tab-content">
                    <div class="tab-pane fade active in" id="baseinfo">
                    	<%@ include file="/WEB-INF/jsp/project/listing/syq/proinfo-base.jsp" %>
                    </div>
                    <!-- 
