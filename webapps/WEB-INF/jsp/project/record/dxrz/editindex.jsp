...
<div class="bjui-pageContent">
		...
		<ul class="nav nav-tabs" role="tablist">
		    <li class="active"><a href="#baseinfo" role="tab" data-toggle="tab">备案信息</a></li>
		      <!-- 
		    <li><a id="otherfiles_link" href="<%=request.getContextPath()%>/debt/proissue/profiles/recordlist.do?projectId=${obj.id}&projectTypeId=${obj.projectTypeId}&memberId=${obj.memberId}" 
		...
		<div class="tab-content">
			...
			<%@ include file="/WEB-INF/jsp/project/record/dxrz/editpro.jsp" %>
			</div>
			<!--
	        <div class="tab-pane fade"  id="otherfiles"></div>
	        -->
	        <div class="tab-pane fade bjui-layout" data-url="<%=request.getContextPath()%>/debt/record/feedlist.do?recordId=${obj.id}" id="feedlist"></div>
		</div>
</div>
