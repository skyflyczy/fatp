...
<div class="bjui-pageHeader">
    <form id="pagerForm" data-toggle="ajaxsearch" action="<%=request.getContextPath()%>/project/record/dxrz/list.do">
        ...
        <div class="bjui-searchBar">
            ...
            <div class="pull-right">
                <div class="btn-group">
                       <a href="<%=request.getContextPath()%>/project/record/dxrz/new.do"
                       		class="btn btn-blue" data-toggle="dialog" data-width="700" data-icon="plus"
                       		data-height="300" data-id="dialog-mask" data-mask="true">新增</a>
                </div>
            </div>
        </div>
    </form>
    	...
    	<tr>
    		...
    		<td align="center">
    				<c:if test="${list.canEdit() }">
		   				<a href="<%=request.getContextPath()%>/project/record/dxrz/edit.do?id=${list.id}" 
		   			...
		   			<c:if test="${list.canDelete() }">	
		   				<a href="<%=request.getContextPath()%>/project/record/dxrz/delete.do?id=${list.recordGuid}" 
