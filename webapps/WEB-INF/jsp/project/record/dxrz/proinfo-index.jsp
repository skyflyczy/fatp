        ...
        <div style="margin:0px auto 0; width:100%;">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li class="active"><a href="#baseinfo" role="tab" data-toggle="tab">产品信息</a></li>
                     <!-- 
                    <li><a href="<%=request.getContextPath()%>/debt/proissue/profiles/view.do?projectId=${obj.id}&belongType=1&projectTypeId=${obj.projectTypeId}" 
            		...
            		<li><a href="<%=request.getContextPath()%>/timeline/record.do?entityId=${obj.id}" 
			                    	role="tab" data-toggle="ajaxtab" data-target="#feedlist" data-reload="false">产品动态</a></li>
                </ul>
                <!-- Tab panes -->
                <div class="tab-content">
                    <div class="tab-pane fade active in" id="baseinfo">
                    	<%@ include file="/WEB-INF/jsp/project/record/dxrz/proinfo-base.jsp" %>
                    </div>
                    <!-- 
